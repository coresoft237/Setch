          ...
          <div class="row content-panel col1">
            <div class="col-lg-10 col-lg-offset-1">
              <div class="invoice-body invoice-body1">
                <div class="pull-left">
                <%
                List<besoin>listebesoin=null;
                listebesoin=(List<besoin>)request.getAttribute("listebesoin");
                String e=(String)request.getAttribute("f");
                ...
                %>
                  <h1> <%out.print(e); %></h1>
                  <address>
                <strong><%out.print(personneservice.getByid(listebesoin.get(0).getNumero())); %></strong><br>
              </address>
                </div>
                <!-- /pull-left -->
                ...
                <div class="row row1">
                  <div class="col-md-9">
                  <h4>Saisie effectuee par</h4>
                   <h5><%out.print(utilisateurservice.getByid(listebesoin.get(0).getUser()).getNom()); %></h5>
                  </div>
                  <!-- /col-md-9 -->
                  <div class="col-md-3">
                    <br>
                    <div class="row2">
                      <div class="pull-left"> Besoin NO : </div>
                      <div class="pull-right "> <%out.print(listebesoin.get(0).getNumero()); %> </div>
                      <div class="clearfix"></div>
                    </div>
                    <div class="row2">
                      <!-- /col-md-3 -->
                      <div class="pull-left"> Date facture : </div>
                      <div class="pull-right"><%out.print(listebesoin.get(0).getDate()); %> </div>
                      <div class="clearfix"></div>
                    </div>
                ...
                <table class="table">
                  ...
                  {
                	  listeoffre=offreservice.getAll3(listebesoin.get(i).getIdarticle(),"actif");
      				person=personneservice.getByid(listeoffre.get(0).getIdfournisseur());
      				Double t=listeoffre.get(0).getPrixvente()*listebesoin.get(i).getQuantite();
                	  %>
                	  <tr>
                	   <td><%out.print(personneservice.getByid(listeoffre.get(0).getIdfournisseur()).getNom()); %></td>
                      <td><%out.print(articleservice.getByid(listebesoin.get(i).getIdarticle()).getNom()); %></td>
                      <td><%out.print(listebesoin.get(i).getQuantite()); %></td>
                      <td class="text-right">F.CFA<%out.print(listeoffre.get(0).getPrixvente()); %></td>
                      <td class="text-right"><%out.print(t); %></td>
                    </tr>
                    <% 
                    total=total+t;
                  }
