...
String option=(String)request.getAttribute("option");
  prixvente prixvente=(prixvente)request.getAttribute("prixvente");
 ...
 <section id="main-content">
    ...
    <div class="container">
      <form class="form-login" method="POST" >
        ...
        <input type="date" name="date" value="<%out.print(prixvente.getDate()); %>" <%if(!prixvente.getDate().equals("")){%>READONLY<%} %> class="form-control" placeholder="Date" autofocus required>
          <br>
           ...
           {
        	   %>
        	   <option value="<%out.print(Listearticle.get(i).getId()); %>" <%if(Listearticle.get(i).getId()==prixvente.getIdarticle()){%>SELECTED<%} %>><%out.print(Listearticle.get(i).getNom()); %></option>
        	   <%
           }
           %>
                </select>
          <br>
        	<input type="number"  min ="1" name="pv" value="<%out.print(prixvente.getPrixvente()); %>" class="form-control" placeholder="Prix vente" autofocus required>
          <br>
