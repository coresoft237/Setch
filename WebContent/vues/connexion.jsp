    ...
    <div class="container">
      <form class="form-login" method="POST" >
        ...
        <div class="login-wrap">
          ...
          <input type="text" name="Login" pattern="[A-Za-z0-9\ }]{1,50}" class="form-control" placeholder="Login" autofocus required>
          <br>
          <input type="password" name="Pwd" pattern="[A-Za-z0-9\ }]{6,20}" class="form-control" placeholder="Mot de passes" autofocus required>
          <br>
          <hr>
