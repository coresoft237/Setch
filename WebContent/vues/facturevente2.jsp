...
%>
<body onLoad="imprimer('<%out.print(valeur);%>');">
      ...
      <div class="nav notify-row" id="top_menu">
        ...
        <ul class="nav top-menu">
          ...
          <li id="header_inbox_bar" class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="./vues/Dashio/index.html#">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="./vues/Dashio/index.html#">
                  <span class="photo"><img alt="avatar" src="./vues/Dashio/img/ui-zac.jpg"></span>
                  <span class="subject">
              ...
              <li>
                <a href="./vues/Dashio/index.html#">
                  <span class="photo"><img alt="avatar" src="./vues/Dashio/img/ui-divya.jpg"></span>
                  <span class="subject">
              ...
              <li>
                <a href="./vues/Dashio/index.html#">
                  <span class="photo"><img alt="avatar" src="./vues/Dashio/img/ui-danro.jpg"></span>
                  <span class="subject">
              ...
              <li>
                <a href="./vues/Dashio/index.html#">
                  <span class="photo"><img alt="avatar" src="./vues/Dashio/img/ui-sherman.jpg"></span>
                  <span class="subject">
              ...
              <li>
                <a href="./vues/Dashio/index.html#">See all messages</a>
              </li>
            </ul>
          </li>
          <!-- inbox dropdown end -->
          ...
          <li id="header_notification_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended notification">
              ...
              <li>
                <a href="./vues/Dashio/index.html#">See all notifications</a>
              </li>
            </ul>
          </li>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="./vues/Dashio/profile.html"><img src="./vues/Dashio/img/ui-sam.jpg" class="img-circle" width="80"></a></p>
              ...
              <div class="invoice-body invoice-body1">
                ...
                <div class="row row1">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="row2">
                      ...
                      <div class="pull-right"><%out.print(personneservice.getByid(facture.getListevente().get(0).getIdprescripteur()).getNom()); %> </div>
                      <div class="clearfix"></div>
                    </div>
                    <!-- /row -->
                    <br>
                ...
                <table class="table">
                  ...
                  for(int i=0;i<facture.getListevente().size();i++)
                  {
                	  ...
                	  System.out.println(facture.getListevente().get(i).getQuantite());
                	  System.out.println(prixventeservice.getByid(facture.getListevente().get(i).getIdprixvente()).getPrixvente());
                	  System.out.println((100-reduction.getReduction()));
