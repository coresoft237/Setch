          ...
          <div class="row content-panel col1">
            <div class="col-lg-10 col-lg-offset-1">
              <div class="invoice-body invoice-body1">
                ...
                %>
                  <h1> <%out.print(personneservice.getByid(listeoffre.get(0).getIdfournisseur()).getNom()); %></h1>
                  <address>
                <strong><%out.print(personneservice.getByid(listeoffre.get(0).getIdfournisseur()).getPhone()); %></strong><br>
              </address>
                </div>
                <!-- /pull-left -->
                ...
                <div class="row row1">
                  ...
                  <h4>Saisie effectuee par</h4>
                   <h5><%out.print(utilisateurservice.getByid(listeoffre.get(0).getUser()).getNom()); %></h5>
                  </div>
                  <!-- /col-md-9 -->
                  <div class="col-md-3">
                    <br>
                    <div class="row2">
                      <div class="pull-left"> Offre NO : </div>
                      <div class="pull-right "> <%out.print(listeoffre.get(0).getNumero()); %> </div>
                      <div class="clearfix"></div>
                    </div>
                    <div class="row2">
                      <!-- /col-md-3 -->
                      <div class="pull-left"> Date facture : </div>
                      <div class="pull-right"><%out.print(listeoffre.get(0).getDate()); %> </div>
                      <div class="clearfix"></div>
                    </div>
                ...
                <table class="table">
                  <thead>
                    <tr>
                      ...
                      <th style="width:140px" class="text-right">STATUT</th>
                    </tr>
                  </thead>
                  <tbody>
                  <%
                  for(int i=0;i<listeoffre.size();i++)
                  {
                      ...
                      <td class="text-right">F.CFA<%out.print(listeoffre.get(i).getPrixvente()); %></td>
                      <td class="text-right"><%out.print(listeoffre.get(i).getStatut()); %></td>
                    </tr>
                    <% 
                  }
