 ...
 <section id="main-content">
      ...
      <form class="form-login" method="POST" >
        ...
        if(executionoperation==false)
        {
          ...
          %>
          <br>
           <select class="form-control" placeholder="soins" id="articlebesoinbis" name=article required >
        <%
        ...
        %>
          ...
          <br>
          <input type="number" name="quantite" min="1"  id="quantitebesoinbis" value="" class="form-control" placeholder="quantite" autofocus required>
          <br>
        	
          <button class="btn btn-theme btn-block" choix="ligneenregistrement" name="button" id="Enregistrementbis" value="Enregistrement" type="button" OncliCk="besoin3bis()"><i class="fa fa-lock"></i>Enregistrement</button>
          <hr>
        ...
        <div class="content-panel">
              ...
              <h4><i class="fa fa-angle-right"></i>DETAIL BESOIN  N <%out.print(listecommande.get(0).getNumero()); %></h4>
              <hr>
              <table class="table">
                <thead>
                  <tr>
              ...
              total=0;
				...
				Double t=listeoffre.get(0).getPrixvente()*listecommande.get(i).getQuantite();
                  ...
                  <td><%out.print(t); %></td>
                   <td> <a href="./login?option=supprimerbesoinbis&id=<%out.print(listecommande.get(i).getId()); %>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></a> </td>      
                  </tr>
                	<% 
          ...
          if(listecommande.size()>0)
          {
        	  %>
        	   ...
        	   <form method="POST">
          		<button class="btn btn-theme btn-block boutonfacture" name="button" value="impression" type="submit"><i class="fa fa-lock"></i>Impression</button>
          		</form>
